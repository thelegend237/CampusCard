      ...
      <div className="flex items-center justify-between w-full">
        ...
        <div className="flex items-center space-x-2 sm:space-x-4 relative">
          ...
          <div className="flex items-center space-x-2">
            ...
            {/* Menu profil popover sur toutes tailles d'écran */}
            {profileMenuOpen && (
              <div className="absolute right-0 top-12 z-50 bg-white rounded-xl shadow-xl border border-gray-200 w-56 p-4 flex flex-col items-center profile-popover">
